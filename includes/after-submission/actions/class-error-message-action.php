...
class Error_Message_Action extends Action_Base
{
    ...
    protected function register_settings(): void
    {
        ...
        $this->add_control('message_bg_color_error_message', [
            'type'    => Controls::COLOR,
            'label'   => __('Background Color', 'smart-form-builder-by-dragwyb'),
            'default' => '#ffffff',
        ]);

        $this->add_control('message_text_color_error_message', [
            'type'    => Controls::COLOR,
