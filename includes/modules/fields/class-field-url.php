...
class Field_Url extends Field_Base {
	...
	protected function register_field_controls(): void {
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'URL', 'smart-form-builder-by-dragwyb' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'https://example.com', 'smart-form-builder-by-dragwyb' ),
			)
		);
	...
	protected function render_field() {
		...
		$label       = $this->field_key_exist( $settings, 'label', 'URL' );
	...
	public function validate( $value, $field_id, $form_config, Form_Submission_Handler $error_handler ): void {
		...
		if ( ! filter_var( $value, FILTER_VALIDATE_URL ) ) {
			$error_handler->add_error( $field_id, __( 'Please enter a valid URL.', 'smart-form-builder-by-dragwyb' ) );
		}
	}
