...
class Field_Address extends Field_Base {
	...
	protected function register_field_controls(): void {
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'Address', 'smart-form-builder-by-dragwyb' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'Street address, City, State, Zip...', 'smart-form-builder-by-dragwyb' ),
			)
		);
	...
	protected function render_field() {
		...
		$label       = $this->field_key_exist( $settings, 'label', 'Address' );
