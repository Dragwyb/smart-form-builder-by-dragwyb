...
class Fonts_Helper {
	...
	private static $google_fonts_enabled = null;
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			...
			self::$font_groups = apply_filters( 'Dragwyb/fonts_list/groups', $font_groups );
		}
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			...
			self::$fonts = array_replace( self::get_native_fonts(), apply_filters( 'Dragwyb/fonts_list/additional_fonts', $additional_fonts ) );
		}
	...
	public static function google_fonts_enabled(): bool {
		if ( null === static::$google_fonts_enabled ) {
			$default_value = '1';

			$option = get_option( 'dragwyb_google_font', $default_value );

			static::$google_fonts_enabled = '1' === $option;
		}

		return static::$google_fonts_enabled;
	}
}
