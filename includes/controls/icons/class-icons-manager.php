...
class Icons_Manager
{
    ...
    private static function render_html_tag(string $tag, array $attributes = []): void
    {
        ...
        echo wp_kses(sprintf('<%1$s %2$s></%1$s>', esc_attr($tag), trim($attributes_string)), array(
     ...
     * @return void
     */
    private static function render_svg_icon(string $icon_type, string $icon_name, array $attributes = []): void
    {
